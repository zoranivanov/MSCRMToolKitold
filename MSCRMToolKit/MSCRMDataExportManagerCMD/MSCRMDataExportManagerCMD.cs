...
{
    internal class MSCRMDataExportManagerCMD
    {
        //private static MSCRMDataExportManager man;
        ...
        private static void Main(string[] args)
        {
            ...
            MSCRMDataExportManager man = new MSCRMDataExportManager();
            ...
            MSCRMDataExportProfile p = man.GetProfile(selectedProfileName);
            if (p == null)
            {
                Console.WriteLine("The specified Profile does not exist.");
                return;
