...
{
    /// <summary>
    /// TransportReportViewer class
    /// </summary>
    public partial class TransportReportViewer : Form
    {
        private string reportFileName = "";
        private string reportFailuresFileName = "";
        private MSCRMTransportationProfilesManager tpm = new MSCRMTransportationProfilesManager();
        private TransportReport report = null;

        /// <summary>
        /// Initializes a new instance of the <see cref="TransportReportViewer"/> class.
        /// </summary>
        public TransportReportViewer()
        {
            InitializeComponent();
        }
        ...
        public TransportReportViewer(string reportFileName, string reportFailuresFileName)
        {
        ...
        private void failuresReportToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            catch (Win32Exception ex)
            {
                ...
                {
                    TransportImportFailuresReportViewer tifrv = new TransportImportFailuresReportViewer(reportFailuresFileName);
                    tifrv.Show();
                }
